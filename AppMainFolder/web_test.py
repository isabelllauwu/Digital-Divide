...
def test_001_loadtitle(dash_br):
    ...
    assert dash_br.find_element("#heatMap")
...
#Iframe on speed test page test
def test_003_check_speed_page(dash_br):
    dash_br.server_url ='http://127.0.0.1:8050'
    dash_br.multiple_click("#speedNav.navItem", 1)
    assert dash_br.find_element("#speedIframe")